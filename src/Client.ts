...
export class Client {
  ...
  convertValue(value: number): string {
    // Use the factory method instead of a hard-coded dependency
  ...
  // Factory method that returns a new Service instance.
  // This method is overridden in tests to inject a mock.
